...
class TaxClient {
    ...
    public static void main(String[] args) {
        ...
        irs.register(corp);
        HourlyEmployee hemp = new HourlyEmployee("John", LocalDate.of(2004, 4, 7), 15, 12);
        irs.register(hemp);
        SalariedEmployee semp = new SalariedEmployee("Bill", LocalDate.of(2003, 12, 31), 1500);
        irs.register(semp);
        Executive boss = new Executive("Rob", LocalDate.of(2022,4,20), 52000);
        irs.register(boss);
